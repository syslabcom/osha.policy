...
class TestSetup(OSHAPolicyTestCase):
    ...
    def test_portaltypes_installed(self):
        ...
        self.failUnless('Publication' in self.types.objectIds())
    ...
    def test_theme_installed(self):
        ...
        layer = skins.getSkinPath('OSHA Theme')
        self.failUnless('osha_theme_custom_templates' in layer)
        self.assertEquals('OSHA Theme', skins.getDefaultSkin())
