...
ecard_name = request.get('ecard_name')+'.swf'
...
ecard = getattr(portal.images, ecard_name)
...
portal.sql.ecard_sql_insert(ecard_key=cid, sender_name=yourname, ecard_name=ecard_name)
